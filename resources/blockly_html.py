...
// -- Function Call --
// -- Function Call without Return (with mutator) --
Blockly.Blocks['procedures_callnoreturn'] = {{
    init: function() {{
        ...
        this.arguments_ = [];
        this.setMutator(new Blockly.icons.MutatorIcon(['procedures_mutatorarg'], this));
        this.setTooltip("Call a function. Click gear to add/remove parameters.");
    }},
    ...
    updateParams_: function() {{
        ...
        // Add new argument inputs based on arguments_ array
        for (let j = 0; j < this.arguments_.length; j++) {{
            this.appendValueInput('ARG' + (j + 1))
                .setCheck(null)
                .appendField(this.arguments_[j] + ':');
        }}
    }},
...
// -- Function Call with Return (with mutator) --
Blockly.Blocks['procedures_callreturn'] = {{
    init: function() {{
        ...
        this.arguments_ = [];
        this.setMutator(new Blockly.icons.MutatorIcon(['procedures_mutatorarg'], this));
        this.setTooltip("Call a function that returns a value. Click gear to add/remove parameters.");
    }},
...
// Mutator container block (for the gear popup)
...
// Mutator argument block (for adding parameters)
